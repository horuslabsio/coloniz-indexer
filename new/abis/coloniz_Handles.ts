...
export default [
  {
    type: 'impl',
    name: 'HandlesImpl',
    interface_name: 'coloniz::interfaces::IHandle::IHandle',
  },
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'coloniz::interfaces::IHandle::IHandle',
    items: [
      {
        type: 'function',
        name: 'mint_handle',
        inputs: [{ name: 'local_name', type: 'core::felt252' }],
      ...
      },
      {
        ...
        inputs: [
          ...
          { name: 'local_name', type: 'core::felt252' },
        ],
        outputs: [{ type: 'core::byte_array::ByteArray' }],
        state_mutability: 'view',
      },
  ...
  {
    type: 'event',
    name: 'coloniz::namespaces::handles::Handles::HandleMinted',
    kind: 'struct',
    members: [
      { name: 'local_name', type: 'core::felt252', kind: 'data' },
  ...
  {
    type: 'event',
    name: 'coloniz::namespaces::handles::Handles::HandleBurnt',
    kind: 'struct',
    members: [
      { name: 'local_name', type: 'core::felt252', kind: 'data' },
      { name: 'token_id', type: 'core::integer::u256', kind: 'data' },
  ...
  {
    type: 'event',
    name: 'coloniz::namespaces::handles::Handles::Event',
    kind: 'enum',
    variants: [
      {
        name: 'ERC721Event',
      ...
      {
        name: 'HandleMinted',
        type: 'coloniz::namespaces::handles::Handles::HandleMinted',
        kind: 'nested',
      },
      {
        name: 'HandleBurnt',
        type: 'coloniz::namespaces::handles::Handles::HandleBurnt',
        kind: 'nested',
      },
    ],
  },
