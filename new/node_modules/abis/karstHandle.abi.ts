export default [
  {
    type: 'impl',
    name: 'HandlesImpl',
    interface_name: 'karst::interfaces::IHandle::IHandle',
  },
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'karst::interfaces::IHandle::IHandle',
    items: [
      {
        type: 'function',
        name: 'mint_handle',
  ...
  {
    type: 'event',
    name: 'karst::namespaces::handles::Handles::HandleMinted',
    kind: 'struct',
    members: [
      {
        name: 'local_name',
  ...
  {
    type: 'event',
    name: 'karst::namespaces::handles::Handles::HandleBurnt',
    kind: 'struct',
    members: [
      {
        name: 'local_name',
  ...
  {
    type: 'event',
    name: 'karst::namespaces::handles::Handles::Event',
    kind: 'enum',
    variants: [
      {
        name: 'ERC721Event',
      ...
      {
        name: 'HandleMinted',
        type: 'karst::namespaces::handles::Handles::HandleMinted',
        kind: 'nested',
      },
      {
        name: 'HandleBurnt',
        type: 'karst::namespaces::handles::Handles::HandleBurnt',
        kind: 'nested',
      },
    ],
  },
