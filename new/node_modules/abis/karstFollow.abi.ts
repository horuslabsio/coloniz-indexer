export default [
  {
    type: 'impl',
    name: 'FollowImpl',
    interface_name: 'karst::interfaces::IFollowNFT::IFollowNFT',
  },
  {
    type: 'struct',
  ...
  {
    type: 'struct',
    name: 'karst::base::constants::types::FollowData',
    members: [
      {
  ...
  {
    type: 'interface',
    name: 'karst::interfaces::IFollowNFT::IFollowNFT',
    items: [
      {
        type: 'function',
        name: 'follow',
      ...
      },
      {
        ...
        outputs: [
          {
            type: 'karst::base::constants::types::FollowData',
          },
        ],
        state_mutability: 'view',
      },
  ...
  {
    type: 'event',
    name: 'karst::follownft::follownft::Follow::Followed',
    kind: 'struct',
    members: [
      {
  ...
  {
    type: 'event',
    name: 'karst::follownft::follownft::Follow::Unfollowed',
    kind: 'struct',
    members: [
      {
  ...
  {
    type: 'event',
    name: 'karst::follownft::follownft::Follow::FollowerBlocked',
    kind: 'struct',
    members: [
      {
        name: 'followed_address',
  ...
  {
    type: 'event',
    name: 'karst::follownft::follownft::Follow::FollowerUnblocked',
    kind: 'struct',
    members: [
      {
        name: 'followed_address',
  ...
  {
    type: 'event',
    name: 'karst::follownft::follownft::Follow::Event',
    kind: 'enum',
    variants: [
      {
        name: 'ERC721Event',
      ...
      {
        name: 'Followed',
        type: 'karst::follownft::follownft::Follow::Followed',
        kind: 'nested',
      },
      {
        name: 'Unfollowed',
        type: 'karst::follownft::follownft::Follow::Unfollowed',
        kind: 'nested',
      },
      {
        name: 'FollowerBlocked',
        type: 'karst::follownft::follownft::Follow::FollowerBlocked',
        kind: 'nested',
      },
      {
        name: 'FollowerUnblocked',
        type: 'karst::follownft::follownft::Follow::FollowerUnblocked',
        kind: 'nested',
      },
    ],
  },
