...
export default [
  {
    type: 'impl',
    name: 'CollectNFTImpl',
    interface_name: 'coloniz::interfaces::ICollectNFT::ICollectNFT',
  },
  {
    type: 'struct',
  ...
  {
    type: 'interface',
    name: 'coloniz::interfaces::ICollectNFT::ICollectNFT',
    items: [
      {
        type: 'function',
        name: 'mint_nft',
      ...
      {
        type: 'function',
        name: 'get_source_publication_pointer',
        inputs: [],
        outputs: [
          {
  ...
  {
    type: 'event',
    name: 'coloniz::publication::collectnft::CollectNFT::Event',
    kind: 'enum',
    variants: [
      {
        name: 'ERC721Event',
