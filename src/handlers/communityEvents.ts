...
import {
  type CommunityBanEvent,
  type CommunityCreatedEvent,
  type CommunityGateKeepEvent,
  type CommunityMemberEvent,
  type CommunityModEvent,
  type CommunityNftEvent,
  type CommunityUpgradeEvent,
} from "../processors/communityProcessors.ts";
...
export async function handleCommunityGateKeeped(
  ...
  await db
    ...
    .set({
      gate_keep_type:
        gateKeepTypeMap[gateKeepType as keyof typeof gateKeepTypeMap],
