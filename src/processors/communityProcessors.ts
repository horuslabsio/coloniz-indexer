...
import { toHex, toNumber, processUint256 } from '../../utils';
...
export function processCommunityCreatedEvent(event: starknet.IEvent): CommunityCreatedEvent {
...
export function processCommunityMemberEvent(event: starknet.IEvent): CommunityMemberEvent {
    const data = event.data;
    if (!data) throw new Error('Processor: Expected event with data');
    return {
        communityId: processUint256(data, 0, 1),
...
export function processCommunityModEvent(event: starknet.IEvent): CommunityModEvent {
    const data = event.data;
    if (!data) throw new Error('Processor: Expected event with data');
    return {
        communityId: processUint256(data, 0, 1),
...
export function processCommunityBanEvent(event: starknet.IEvent): CommunityBanEvent {
    const data = event.data;
    if (!data) throw new Error('Processor: Expected event with data');
    return {
        communityId: processUint256(data, 0, 1),
...
export function processCommunityUpgradeEvent(event: starknet.IEvent): CommunityUpgradeEvent {
    const data = event.data;
    if (!data) throw new Error('Processor: Expected event with data');
    return {
        communityId: processUint256(data, 0, 1),
...
export function processCommunityGateKeepEvent(event: starknet.IEvent): CommunityGateKeepEvent {
    const data = event.data;
    if (!data) throw new Error('Processor: Expected event with data');
    return {
        communityId: processUint256(data, 0, 1),
...
export function processCommunityNftEvent(event: starknet.IEvent): CommunityNftEvent {
    const data = event.data;
    if (!data) throw new Error('Processor: Expected event with data');
    return {
        communityId: processUint256(data, 0, 1),
