 ...
 * @since 0.67.0
 */
export declare const TemplateLiteral: <T extends readonly [TemplateLiteralParameter, ...TemplateLiteralParameter[]]>(...[head, ...tail]: T) => TemplateLiteral<Join<T>>;
/**
...
export declare const optional: {
    ...
    <S extends Schema.All, Options extends OptionalOptions<Schema.Type<S>>>(self: Schema.All extends S ? "you can't apply optional implicitly, use optional() instead" : S, options?: Options): [undefined] extends [Options] ? optional<S> : optionalWithOptions<S, Options>;
};
/**
 * @since 0.67.0
 */
...
export interface TypeLiteral<Fields extends Struct.Fields, Records extends IndexSignature.Records> extends AnnotableClass<TypeLiteral<Fields, Records>, Types.Simplify<TypeLiteral.Type<Fields, Records>>, Types.Simplify<TypeLiteral.Encoded<Fields, Records>>, Struct.Context<Fields> | IndexSignature.Context<Records>> {
    ...
    make(props: Types.Simplify<TypeLiteral.Constructor<Fields, Records>>, options?: MakeOptions): Types.Simplify<TypeLiteral.Type<Fields, Records>>;
}
/**
 * @category api interface
 * @since 0.67.0
 ...
 * @since 0.67.0
 */
export declare const pick: <A, I, Keys extends readonly (keyof A & keyof I)[]>(...keys: Keys) => <R>(self: Schema<A, I, R>) => SchemaClass<Pick<A, Keys[number]>, Pick<I, Keys[number]>, R>;
/**
 * @category struct transformations
 * @since 0.67.0
 */
export declare const omit: <A, I, Keys extends readonly (keyof A & keyof I)[]>(...keys: Keys) => <R>(self: Schema<A, I, R>) => SchemaClass<Omit<A, Keys[number]>, Omit<I, Keys[number]>, R>;
/**
 ...
 * @since 0.67.0
 */
export declare const minItems: <A>(n: number, annotations?: Annotations.Filter<array_.NonEmptyReadonlyArray<A>, ReadonlyArray<A>>) => <I, R>(self: Schema<ReadonlyArray<A>, I, R>) => refine<array_.NonEmptyReadonlyArray<A>, Schema<ReadonlyArray<A>, I, R>>;
/**
 * @category type id
 * @since 0.67.0
 */
...
export interface Class<Self, Fields extends Struct.Fields, I, R, C, Inherited, Proto> extends Schema<Self, Types.Simplify<I>, R> {
    new (props: RequiredKeys<C> extends never ? void | Types.Simplify<C> : Types.Simplify<C>, options?: MakeOptions): Struct.Type<Fields> & Omit<Inherited, keyof Fields> & Proto;
